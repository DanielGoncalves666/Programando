...
OLA="Olá, mundo!"
#OLA é uma variável na qual foi salvada essa frase
#cuidado com espaços entre o =, a declaração e o conteudo. Isso não é permitido

echo $OLA
#para usar a variavel utilizamos  $ antes
