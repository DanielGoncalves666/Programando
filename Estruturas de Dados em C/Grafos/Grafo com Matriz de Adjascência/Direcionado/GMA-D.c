...
Descrição: insere a aresta (v1,v2) no grafo, caso v1 e v2 existam. A ordem dos argumentos importa.
...
Entrada: tipo Grafo
         inteiro, indicando a primeira ponta da aresta
         inteiro, indicando a segunda ponta da aresta
Descrição: remove a aresta (v1,v2) do grafo, se ela existir. A ordem dos argumentos importa 
