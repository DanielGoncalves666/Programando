...
pegaSobrenome ((_,_,sobrenome), (_,_), _, (_,_,_)) = sobrenome

pegaSobrenomeNome :: Nome -> String
pegaSobrenomeNome (_,_,sobrenome) = sobrenome

pegaSobrenome' :: Pessoa -> String
pegaSobrenome' p = pegaSobrenomeNome( pegaNome p)